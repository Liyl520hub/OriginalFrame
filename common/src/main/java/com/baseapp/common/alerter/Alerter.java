...
public final class Alerter {
    ...
    public static Alerter create(@NonNull final Dialog dialog) {
        if (dialog == null) {
            throw new IllegalArgumentException("Activity cannot be null!");
        }
    ...
    public static void clearCurrent(@NonNull final Dialog dialog) {
        if (dialog == null) {
            return;
        }

        try {
            final ViewGroup decorView = (ViewGroup) dialog.getWindow().getDecorView();
    ...
    public static boolean isShowing() {
        ...
        if (dialogWeakReference != null && dialogWeakReference.get() != null){
            isShowing = dialogWeakReference.get().findViewById(R.id.flAlertBackground) != null;
        }
    ...
    public Alert show() {
        ...
        if (getDialogWeakReference() != null){
            ViewGroup decorView = getDialogDecorView();
            if (decorView != null && getAlert().getParent() == null){
                decorView.addView(getAlert());
            }
        }
    ...
    ViewGroup getDialogDecorView(){
        ...
        if (getDialogWeakReference() != null && getDialogWeakReference().get() != null) {
            decorView = (ViewGroup) getDialogWeakReference().get().getWindow().getDecorView();
        }
     ...
     * @param dialog
     */
    private void setDialog(@NonNull Dialog dialog){
